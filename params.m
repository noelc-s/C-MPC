...
p.E = 0.001; % size of robust invariant
...
p.xd_delay = floor(2 * p.MPC.dt / p.ll_dt); % desried trajectory update delay in ll_ticks -- this is one mpc timing cycle off
